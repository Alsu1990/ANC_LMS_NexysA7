...
## Pmod Header JA
set_property -dict {PACKAGE_PIN G13 IOSTANDARD LVCMOS33} [get_ports ja_1]
set_property -dict {PACKAGE_PIN B11 IOSTANDARD LVCMOS33} [get_ports ja_2]
set_property -dict {PACKAGE_PIN A11 IOSTANDARD LVCMOS33} [get_ports ja_3]
set_property -dict {PACKAGE_PIN D12 IOSTANDARD LVCMOS33} [get_ports ja_4]
# set_property -dict { PACKAGE_PIN D13   IOSTANDARD LVCMOS33 } [get_ports { ja_7 }]; #IO_L6N_T0_VREF_15 Sch=ja[7]
# set_property -dict { PACKAGE_PIN B18   IOSTANDARD LVCMOS33 } [get_ports { ja_8 }]; #IO_L10P_T1_AD11P_15 Sch=ja[8]
# set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS33 } [get_ports { ja_9 }]; #IO_L10N_T1_AD11N_15 Sch=ja[9]
set_property -dict {PACKAGE_PIN K16 IOSTANDARD LVCMOS33} [get_ports ja_10]

## Pmod Header JB
set_property -dict {PACKAGE_PIN E15 IOSTANDARD LVCMOS33} [get_ports jb_1]
set_property -dict {PACKAGE_PIN E16 IOSTANDARD LVCMOS33} [get_ports jb_2]
set_property -dict {PACKAGE_PIN D15 IOSTANDARD LVCMOS33} [get_ports jb_3]
set_property -dict {PACKAGE_PIN C15 IOSTANDARD LVCMOS33} [get_ports jb_4]
# set_property -dict { PACKAGE_PIN J17   IOSTANDARD LVCMOS33 } [get_ports { jb_7 }]; #IO_L23P_T3_FOE_B_15 Sch=jb_p[3]
# set_property -dict { PACKAGE_PIN J18   IOSTANDARD LVCMOS33 } [get_ports { jb_8 }]; #IO_L23N_T3_FWE_B_15 Sch=jb_n[3]
# set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { jb_9 }]; #IO_L24P_T3_RS1_15 Sch=jb_p[4]
# set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { jb_10 }]; #IO_L24N_T3_RS0_15 Sch=jb_n[4]
...
set_output_delay -clock [get_clocks eth_tx_clk] -min -add_delay 0.000 [get_ports {eth_txd[*]}]
set_output_delay -clock [get_clocks eth_tx_clk] -max -add_delay 1.100 [get_ports {eth_txd[*]}]
set_output_delay -clock [get_clocks eth_tx_clk] -min -add_delay 0.000 [get_ports eth_rstn]
set_output_delay -clock [get_clocks eth_tx_clk] -max -add_delay 1.100 [get_ports eth_rstn]
...
set_property DRIVE 12 [get_ports {eth_txd[3]}]
set_property DRIVE 12 [get_ports {eth_txd[2]}]
set_property DRIVE 12 [get_ports {eth_txd[1]}]
set_property DRIVE 12 [get_ports {eth_txd[0]}]
set_property SLEW SLOW [get_ports eth_ref_clk]


connect_debug_port u_ila_0/probe0 [get_nets [list {eth_logger/eth_udp_send/state[0]} {eth_logger/eth_udp_send/state[1]} {eth_logger/eth_udp_send/state[2]} {eth_logger/eth_udp_send/state[3]}]]
...
connect_debug_port u_ila_0/clk [get_nets [list eth_tx_clk_IBUF_BUFG]]
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe0]
set_property port_width 4 [get_debug_ports u_ila_0/probe0]
connect_debug_port u_ila_0/probe0 [get_nets [list {eth_txd_OBUF[0]} {eth_txd_OBUF[1]} {eth_txd_OBUF[2]} {eth_txd_OBUF[3]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 1 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list eth_tx_en_OBUF]]
set_property C_CLK_INPUT_FREQ_HZ 300000000 [get_debug_cores dbg_hub]
set_property C_ENABLE_CLK_DIVIDER false [get_debug_cores dbg_hub]
set_property C_USER_SCAN_CHAIN 1 [get_debug_cores dbg_hub]
connect_debug_port dbg_hub/clk [get_nets eth_tx_clk_IBUF_BUFG]
