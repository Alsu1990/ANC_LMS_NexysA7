...
#
# Generated by Vivado on Tue May 03 18:42:48 +0300 2022
...
# Script info
echo -e "clk_gen.sh - Script generated by export_simulation (Vivado v2021.2 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic" +incdir+"C:/Xilinx/Vivado/2021.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic" +incdir+"C:/Xilinx/Vivado/2021.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" +incdir+"C:/Xilinx/Vivado/2021.2/data/xilinx_vip/include" \
    "$ref_dir/../../../ip/clk_gen/clk_gen_clk_wiz.v" \
    "$ref_dir/../../../ip/clk_gen/clk_gen.v" \
  2>&1 | tee -a vlogan.log
