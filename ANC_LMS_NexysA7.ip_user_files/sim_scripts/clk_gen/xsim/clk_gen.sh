...
#
# Generated by Vivado on Fri Feb 25 10:11:05 +0200 2022
...
# Script info
echo -e "clk_gen.sh - Script generated by export_simulation (Vivado v2021.1.1 (64-bit)-id)\n"
...
simulate()
{
  xsim clk_gen -key {Behavioral:sim_1:Functional:clk_gen} -tclbatch cmd.tcl -protoinst "protoinst_files/ANC_PROJ_BD.protoinst" -log simulate.log
}
